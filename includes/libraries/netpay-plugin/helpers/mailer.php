<?php
if (! class_exists('NetPayPluginHelperMailer')) {
    class NetPayPluginHelperMailer {
        /**
        ...
        public static function processing_admin_notification( $order_id, $order ) {
            ...
            if (is_a( $payment_gateway, 'NetPay_Payment' ) && $payment_gateway->is_enabled_processing_notification()) {
        ...
        public static function disable_merchant_order_on_hold( $recipient, $order ) {
            ...
            if (is_a($order, 'WC_Order') && 
                is_a( $payment_gateway, 'NetPay_Payment' ) &&
