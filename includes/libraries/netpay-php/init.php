...
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayCardinalAuth.php';
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayVault.php';
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayCardinalValidate.php';
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayZoneAware.php';
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayOxxoPayEnable.php';
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayOxxoTransaction.php';
require_once dirname(__FILE__).'/lib/NetPay/Handlers/NetPayOxxoPayDataHandler.php';
require_once dirname(__FILE__).'/lib/NetPay/Api/NetPayOxxoPay.php';
...
require_once dirname(__FILE__).'/lib/NetPay/Handlers/NetPayCardinalDataHandler.php';
