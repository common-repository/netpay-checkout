...
class NetPay_Localization {
	...
	public static function translate( $message ) {
		$known_messages = array(
			...
			'failed processing'
				=> __( 'Payment encountered an unexpected error, please try again later.', 'netpay' ),
			...
			'payment rejected'
				=> __( 'Payment rejected, please try again and make sure the card info is entered correctly. If the issue persists, please change to another card or contact your bank.', 'netpay' ),
