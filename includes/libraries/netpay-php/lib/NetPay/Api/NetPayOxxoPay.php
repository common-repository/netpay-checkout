...
use \NetPay\Handlers\NetPayOxxoPayDataHandler;
...
class NetPayOxxoPay
{
    ...
    {
        $fields = NetPayOxxoPayDataHandler::prepare($data);
        $fields_string = json_encode($fields);
        $curl_result = NetPayCurl::post(NetPayConfig::$OXXOPAY_URL, $fields_string, $privateKey);
