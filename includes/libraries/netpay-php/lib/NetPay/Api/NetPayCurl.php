...
class NetPayCurl
{
     ...
     */
    public static function post($url, $fields_string, $privateKey = null, $user_agent=null)
    {
        //open connection
        $ch = curl_init();
        ...
        $http_header = array(
            ...
            'Expect:',
            'netpay-sdk: WooCommerce',
            'netpay-sdk-version: 1.59.38'
        );
     ...
     */
    public static function get($url, $privateKey = null, $xApiKey = null)
    {
        //open connection
        $ch = curl_init();
