<?php
  $assetUrl = NetPay::get_assets_url();
  $netpayCardGateway = new NetPay_Payment_Creditcard();
  $cardFormTheme = $netpayCardGateway->get_option('card_form_theme');
  $cardIcons = $netpayCardGateway->get_card_icons();
  $publicKey = NetPay()->settings()->public_key();
...
<div class="wrap netpay">
  ...
  <h2><?php echo _e('NetPay card form customization', 'netpay'); ?></h2>
  ...
  <form method="POST">
    ...
    <table class="form-table">
      ...
      <tr>
        ...
        <td>
          <select id="netpay_sf_font_name" class="select-input" name="font[name]">
      ...
      <tr id="netpay_sf_custom_font_name" style="display: none;">
      ...
      <tr>
        <td>
          <input type="submit" name="netpay_customization_submit" class="button button-primary" value="Save settings">
          <button id="form-preview" class="button button-preview">Preview</button>
        </td>
        <td>
          <input type="submit" name="netpay_customization_reset" class="button button-reset" value="Reset to default settings">
        </td>
      </tr>
  ...
  <div class="netpay-modal" id="netpay-modal">
    <div class="content">
      <div class="body">
        <div id="netpay-card" style="width:100%"></div>
      </div>
      <div class="footer">
...
<script src="<?php echo NetPay::NETPAY_JS_LINK ?>"></script>
<script>
  ...
  window.NETPAY_CUSTOM_FONT_OTHER = `<?php echo $customFontOther ?>`;
</script>
<script src="<?php echo $assetUrl . '/javascripts/netpay-embedded-card.js'; ?>"></script>
