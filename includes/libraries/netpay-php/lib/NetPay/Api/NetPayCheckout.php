...
class NetPayCheckout
{
     ...
     */
    public static function post($privateKey, $data, $installments=null, $user_agent=null)
    {
        $fields = NetPayCheckoutDataHandler::prepare($data, $installments);
        $fields_string = json_encode($fields);
        $curl_result = NetPayCurl::post(NetPayConfig::$CHECKOUT_URL, $fields_string, $privateKey, $user_agent);
